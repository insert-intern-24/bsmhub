      ...
      <div className="flex items-center gap-3 self-stretch">
        ...
        <div className="flex  items-center gap-2 flex-1 rounded-3xl border border-[#D8D8D8] px-2 max-w-[23.125rem] bg-white min-h-[3rem]">
          <input
            ...
            className="flex-1 text-textDisabled text-base font-normal leading-[150%] tracking-normal outline-none select-none"
            value={inputQuery}
            onChange={(e) =>
              setSearchQuery((prev) => {
        ...
        <button className="flex min-w-20 px-4 justify-center items-center gap-1 rounded-[3.125rem] bg-black min-h-[3rem]">
          <span className="flex-1 text-white text-center text-base font-normal leading-[150%] tracking-normal select-none">
            적용하기
          </span>
        </button>
      </div>
