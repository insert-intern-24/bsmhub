...
const ProjectSidebar = ({
  ...
  return (
    <aside
      ref={sidebarRef}
      className="flex-shrink-0 w-[21.75rem] min-h-[50rem] min-w-[21.75rem] self-start mobile:static mobile:w-full mobile:min-w-0 mobile:border-0 mobile:px-0 mobile:pb-8"
    >
      <ProfileIcon image={project.iconImage} />

      <div className="flex flex-col w-full gap-[1.625rem] pt-[4.5rem]">
        <ProjectSummarySection
          title={project.title}
          description={project.introduction}
        />

        {/* Sticky 영역: Edit 버튼부터 기여자까지 */}
        <div className="sticky top-24 mobile:static">
          {/* Edit 버튼 */}
