...
function DetailBox({ label, symbol, length = 0, contents, type}: DetailBoxProps) {
  return (
	<div className={`block max-w-[21.0625rem] w-full overflow-auto h-auto mb-[1.2rem] ${type === "row" && "min-h-[9rem] p-14px border border-strokeColor rounded-lg" }`}>
